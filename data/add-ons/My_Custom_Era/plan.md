...
## Current State
- Forked War of Legends add-on into `My_Custom_Era` in userdata add-ons folder
- All WoL paths renamed to My_Custom_Era
...
7. Add faction to My_Custom_Era era (replace Rebels clone placeholder)
